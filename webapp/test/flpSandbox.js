		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "productosApp",
									"targetURL": "#cursoproductos-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cursoproductos-display": {
								"semanticObject": "cursoproductos",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=curso.productos",
									"url": sap.ui.require.toUrl("curso/productos")
								}
							}
						}
					}
